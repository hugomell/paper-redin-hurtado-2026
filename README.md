...
* `data/` - all the data files (untracked by git because of sensitive
  nature of some variables - cf OSF preregistration)
* 

```bash
# %% Setup project skeleton

mkdir -p data/{archive,raw,processed} .config/rix R analyses docs/
